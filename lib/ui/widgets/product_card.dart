...
class ProductCard extends StatelessWidget {
  ...
  const ProductCard({Key key, this.productItem}) : super(key: key);
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.0),
          Text(productItem.name, style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          Expanded(
            child: Align(
              ...
              child: Container(
                ...
                child: Text("₦${productItem.price}", style: TextStyle(color: Colors.white),),
                ),
              ),
            ),
        ],
