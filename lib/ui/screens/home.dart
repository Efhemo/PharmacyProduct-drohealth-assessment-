  ...
  Widget build(BuildContext context) {
    return Consumer<ProductViewModel>(
      builder: (context, provider, child) {
        ...
        final pharmacyProducts = provider.products;
        return Scaffold(
          body: Stack(
            children: [
              Scaffold(
                      ...
                      title: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              CircleButton(icon: Icons.search, onTap: () => provider.toggleShowSearchbar()),
                            ],
                          )),
                    ),
                    SliverToBoxAdapter(
                      child: provider.isShowSearchBar ? CustomSearchBar(
